...
const services = [
  ...
  },
  {
    ...
    body: 'Agentic systems go further than standard AI tools. They reason through multi-step problems, use APIs and databases as tools, and complete tasks autonomously, with human oversight built in at the points that matter. We design and deploy agents tailored to your operations, from internal research assistants to customer-facing copilots.',
    color: 'text-pink',
