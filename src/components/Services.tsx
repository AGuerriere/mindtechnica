    ...
    <>
      ...
      <div className="md:w-2/6 mb-5">
        <ul className="leading-10 md:text-lg">
          ...
          <li className={`${activeElement === 5 ? 'text-yellow' : '' } cursor-pointer`} onClick={()=> updateContent(`We design, provision and manage secure, cost-efficient cloud environments on AWS that scale with your business, from infrastructure-as-code provisioning to security hardening and compliance-aligned deployments.`, 5)}>Cloud Infrastructure and Security</li>
          <li className={`${activeElement === 6 ? 'text-yellow' : '' } cursor-pointer`} onClick={()=> updateContent(`We build and deploy voice agents that handle real phone conversations, inbound and outbound, answering calls, resolving enquiries, booking appointments, following up with leads and qualifying prospects before your team picks up.`, 6)}>AI Voice Agents</li>
        </ul>
      </div>
